    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background: dodgerblue; color:white">
          <center>
          <img class="modal-title" src="vistas/img/plantilla/agregarusuarios.png" width="320px">
          </center>
        </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background: dodgerblue; color:white">
          <center>
          <img class="modal-title" src="vistas/img/plantilla/editarusuarios.png" width="320px">
          </center>
        </div>
